...
# Load .env from the same folder as this file (memory/.env)
load_dotenv(dotenv_path=Path(__file__).parent / ".env")

# local default: a file called memory.db in this folder
DEFAULT_LOCAL_URL = "sqlite:///./memory.db"

DATABASE_URL = os.environ.get("DATABASE_URL", DEFAULT_LOCAL_URL)

# SQLite needs this flag to allow use across FastAPI's request threads;
