  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/events/report`, {
        ...
        body: JSON.stringify({
          description:
            formData.description || `Event of type ${formData.event_cause}`,
      ...
      const bestMatch =
        data.text_similar_reports && data.text_similar_reports.length > 0
          ? data.text_similar_reports[0]
          : data.precedent &&
              data.precedent.matches &&
              data.precedent.matches.length > 0
            ? data.precedent.matches[0]
            : null;

      setResult({
        matched_event_id: bestMatch ? `EVT-${bestMatch.id}` : "N/A",
        matched_description: bestMatch
          ? bestMatch.description
          : "No similar historical event found",
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      <div>
        ...
        <p style={{ ...typography.subtitle, margin: 0, marginTop: "2px" }}>
          Estimate congestion clearance time for a planned event
        </p>
      </div>
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  height: "20px",
                  borderRadius: "99px",
                  backgroundColor: requiresRoadClosure
                    ? colors.accent
                    : "#E5E7EB",
                  display: "flex",
                  alignItems: "center",
              ...
              >
                <div
                  style={{
                    ...
                    position: "absolute",
                    left: requiresRoadClosure ? "18px" : "2px",
            ...
            >
              ...
              <textarea
                ...
                placeholder="Describe the event in English or Kannada... ಕಾರ್ಯಕ್ರಮದ ವಿವರಣೆ ನಮೂದಿಸಿ..."
                style={{
                  padding: "8px 12px",
                  borderRadius: "6px",
                  border: `1px solid ${colors.border}`,
      ...
      {savedScenarios.length > 0 && (
        ...
        >
          ...
          >
            <h2 style={{ ...typography.label, fontSize: "12px", margin: 0 }}>
              Scenario Comparison
            </h2>
            <button
          ...
          <div style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
            {savedScenarios.map((scenario, idx) => {
              const causeColor =
                colors.causes[scenario._formData.event_cause] ||
                colors.causes.others;
              return (
                <div
                  key={idx}
                  style={{ ...cards.base, width: "220px", padding: "16px" }}
                >
                  <div
                    style={{
                      display: "flex",
                  ...
                  >
                    ...
                    >
                      {scenario._formData.corridor} ·{" "}
                      {scenario._formData.police_station}
                    </div>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      <span style={{ ...typography.value, fontSize: "20px" }}>
                        {scenario.predicted_minutes}
                      </span>
                      <span
                        style={{ ...typography.subtitle, fontSize: "11px" }}
                      >
                        min
                      </span>
                    </div>
