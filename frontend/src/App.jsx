...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: typography.fontFamily, color: colors.textPrimary, backgroundColor: colors.bg, minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            ...
            <span style={{ fontSize: '11px', color: colors.textSecondary }}>Model active</span>
          </div>
          ...
          <button 
            ...
            style={{ 
              ...
              color: colors.textSecondary, padding: '4px', borderRadius: '4px' 
            }}
        ...
        <div style={{
          ...
          <nav style={{ flexGrow: 1 }}>
            ...
            {NAV_ITEMS.map((item) => {
              ...
              const bg = isActive ? 'var(--color-active-bg)' : (isHovered ? 'var(--color-hover-bg)' : 'transparent');
              const fg = isActive ? colors.accent : colors.textPrimary;
              const borderLeft = isActive ? `2px solid ${colors.accent}` : '2px solid transparent';
              const matchesSearch = searchQuery.trim() && item.label.toLowerCase().includes(searchQuery.toLowerCase());
              ...
              return (
                ...
                >
                  ...
                  {matchesSearch && <span style={{ width: '6px', height: '6px', borderRadius: '50%', backgroundColor: colors.accent }} />}
                </div>
              );
            })}
          </nav>
          <div style={{ padding: '16px', fontSize: '11px', color: colors.textTertiary }}>
            v0.1 · Prototype
          </div>
        </div>
