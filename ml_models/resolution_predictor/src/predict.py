...
def load_artifacts(model_dir: str = MODEL_DIR) -> dict:
    ...
    # Load baseline medians as fallback for completely unknown event types
...
def predict(artifacts: dict, event: dict) -> dict:
    ...
    try:
        ...
        # Graceful fallback to median if something breaks
    ...
    # Rough confidence band: ±30 min (conservative; replace with real residual std after eval)
